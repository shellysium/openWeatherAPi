...
function changeWeather(response, temp) {
  if (temp <= 0) {
    ...
    body.style.backgroundImage =
      "https://images.unsplash.com/photo-1522163723043-478ef79a5bb4?ixid=MnwxMjA3fDB8MHxwaG90[…]fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=813&q=80";
  } else {
    body.style.backgroundImage =
...
btn.addEventListener("click", function () {
  ...
  if (cityName != "") {
    ...
    const API = `https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=991d030be77cc75ad4bb6548178d5cce&units=metric`;
